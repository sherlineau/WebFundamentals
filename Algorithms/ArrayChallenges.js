...
function fibonacciArray(n) {
    ...
    var fibArr = [0, 1];
    // your code here
    for ( var i = 0; i <= n-3 ; i++) { // n - 3 -> 2 for length of starting array fib [0,1] + 1 for the -1 length of function array
        var sum = fibArr[fibArr.length - 1] + fibArr[fibArr.length-2]; // [fibArr.length -1] = last index in array [fibArr.length - 2]  = 2nd to last index in array
        fibArr.push(sum);
    }
    return fibArr;
}
